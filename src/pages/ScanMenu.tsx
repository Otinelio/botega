...
import { ShoppingCart, Plus, Minus, Trash2, X, Send, MessageCircle, Hash } from 'lucide-react';
    ...
    <div className="min-h-screen bg-beige">
      ...
      <header className="sticky top-0 z-40 bg-earth-dark/95 backdrop-blur-lg px-6 py-4">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          ...
          <div className="bg-terracotta px-4 py-2 rounded-full flex items-center gap-1.5">
